...
#import "IFATAppletTraceManager.h"
...
#import "FATAppletH5WebviewDelegate.h"
#import "FATAppletInteractionManager.h"
#import "FATAppletCustomJSInjectionDelegate.h"
#import "FATAppletH5CommonDelegate.h"
...
/** 小程序回溯功能的代理事件 */
@property (nonatomic, weak) id<FATAppletTraceDelegate> appletTraceDelegate;
...
/**
 小程序用户交互的代理事件
 */
@property (nonatomic, weak) id<FATAppletInteractionDelegate> appletInteractionDelegate;

/**
 小程序用户交互的管理器
 */
@property (nonatomic, strong) FATAppletInteractionManager *appletInteractionManager;
...
/**
 小程序注入自定义js内容的代理事件
 */
@property (nonatomic, weak) id<FATAppletCustomJSInjectionDelegate> customJSInjectionDelegate;
...
/** 可回溯日志管理者 */
@property (nonatomic, strong) id<IFATAppletTraceManager> appletTraceManager;
...
/**
 小程序webview组件的代理方法
 */
@property (nonatomic, weak) id<FATAppletH5WebviewDelegate> h5WebviewDelegate;

/**
 H5页面通用的代理方法
 */
@property (nonatomic, weak) id<FATAppletH5CommonDelegate> h5CommonDelegate;
...
- (void)bringCurrentAppletToForeground;
- (void)sendCurrentAppletToBackground;

- (void)bringAppletToForeground:(NSString *)appletId;
- (void)sendAppletToBackground:(NSString *)appletId;
...
- (BOOL)registerWkWebViewURLSchemeHandler:(id <WKURLSchemeHandler>)urlSchemeHandler forURLScheme:(NSString *)urlScheme API_AVAILABLE(ios(11.0));
...
- (NSString *)absolutePathWithAppletId:(NSString *)appletId finFilePath:(NSString *)finfilePath needFileExist:(BOOL)needFileExist;
...
/**
 刷新当前加载的H5页面
 如果小程序当前页面加载的是H5，并且触发reload成功，则返回YES
 其他情况 返回NO
 */
- (BOOL)reloadCurrentWebView;
