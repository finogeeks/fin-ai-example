...
typedef NS_ENUM(NSInteger, FATAppletThemeStyle) {
    FATAppletThemeNone    = 0,    //不设置
    FATAppletThemeLight   = 1,    // 浅色模式
    FATAppletThemeDark    = 2,    // 深色模式
    FATAppletThemeAuto    = 3,    // 主题模式跟随系统
};
...
typedef NS_ENUM(NSInteger, FATAuthDescStrategy) {
    FATAuthDescStrategyNone   = 0,    // 默认方式，后台管理系统有配置权限说明，显示配置的，没配置则不显示
    FATAuthDescStrategyShowDefault    = 1,    // 后台管理系统有配置权限说明，显示配置的，没配置显示内置的权限信息
